...
typedef mutex_t OSSpinLock;
#define OSSpinLock mutex_t
#define OSSpinLockTry(l) pthread_mutex_trylock(l)
#define OSSpinLockLock(l) pthread_mutex_lock(l)
#define OSSpinLockUnlock(l) pthread_mutex_unlock(l)
#define OS_SPINLOCK_INIT MUTEX_INITIALIZER
#define pthread_key_init_np(k,d) pthread_key_create(const_cast<pthread_key_t*>(&k), &d)

#define BREAKPOINT_FUNCTION(...)

...
extern const char *map_images(int state, uint32_t infoCount, const struct dyld_image_info infoList[]);
extern const char *map_images_nolock(int state, uint32_t infoCount, const struct dyld_image_info infoList[]);
extern const char * load_images(int state, uint32_t infoCount, const struct dyld_image_info infoList[]);
extern BOOL load_images_nolock(int state, uint32_t infoCount, const struct dyld_image_info infoList[]);
